FROM google/cloud-sdk:458.0.1-alpine@sha256:b3dcaae81d54c2475f851cd960ddade8d77d9ed9c4ed006a7a66a67247457e1d AS base
...
FROM google/cloud-sdk:458.0.1-alpine@sha256:b3dcaae81d54c2475f851cd960ddade8d77d9ed9c4ed006a7a66a67247457e1d
